...
namespace APICatalogojogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<JogoViewModel>> InserirJogo([FromBody] JogosInputModel jogoInputModel)
        {
            try
            {
        ...
        [HttpPut("{idJogo:guid}")]
        public async Task<ActionResult> AtualizarJogo([FromRoute] Guid idJogo, [FromBody] JogosInputModel jogoInputModel)
        {
            try
            {
        ...
        public async Task<ActionResult> AtualizaJogo([FromRoute] Guid idJogo, [FromBody] JogosInputModel jogoInputModel)
        {
            try
            {
                await _jogoService.Atualizar(idJogo, jogoInputModel);
